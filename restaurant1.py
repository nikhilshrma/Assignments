...
#-----------------INFO TOP------------
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="Strabucks",fg="steel blue",bd=10,anchor='w')
...
btnbill=Button(f1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,16,'bold'),width=10, text="SAVE BILL", bg="red",command=billsave)
